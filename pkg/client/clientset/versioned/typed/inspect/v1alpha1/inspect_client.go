...
import (
	...
	"github.com/myoperator/inspectoperator/pkg/client/clientset/versioned/scheme"
...
func (c *ApiV1alpha1Client) Inspects(namespace string) InspectInterface {
	return newInspects(c, namespace)
}
